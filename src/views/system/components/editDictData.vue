<template>
  <el-dialog v-model="dialogVisible" title="编辑字典数据" width="40%" center top="10px" class="editDict" @close="handleClosedDialog(formRef)" :close-on-click-modal="false">
...
const submit = (formRef) => {
  ...
  formRef.validate((valid) => {
    if (valid) {
      ...
      dictApi.dataEdit(param).then(res => {
