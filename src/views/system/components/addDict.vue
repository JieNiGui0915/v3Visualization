<template>
  <el-dialog v-model="dialogVisible" title="添加字典类型" width="40%" center top="10px" class="addDict" @close="handleClosedDialog(formRef)" :close-on-click-modal="false">
...
const submit = (formRef) => {
  ...
  formRef.validate((valid) => {
    if (valid) {
      ...
      dictApi.typeAdd(param).then(res => {
