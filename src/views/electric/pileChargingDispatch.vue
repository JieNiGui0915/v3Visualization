<template>
    <div class="pileChargingDispatch page-wrap" ref="pileChargingDispatchRef">
        <div class="header">
...
const pileChargingDispatchRef = useTemplateRef('pileChargingDispatchRef');
const globalStore = GlobalStore();
watch(() => globalStore.screenSize, val => {
    nextTick(() => {
        if (pileChargingDispatchRef.value) {
            tableHeight.value = pileChargingDispatchRef.value.clientHeight - 122;
        }
    })
}, { immediate: true })
onMounted(() => {
