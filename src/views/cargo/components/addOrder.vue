<template>
  <el-dialog v-model="dialogVisible" title="添加任务" center top="30px" class="addOrder" width="80%"
      ...
      <div class="flex-align-start">
        ...
        <div class="flex-1">
          ...
          <el-form-item label="装货点" prop="loadAddressId">
            <!-- <el-input v-model="form.loadAddress" clearable></el-input> -->
...
const submit = (formRef) => {
  ...
  formRef.validate((valid) => {
    if (valid) {
      loading.value = true;
      orderApi.addOrder(form.value).then(res => {
