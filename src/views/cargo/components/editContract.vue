<template>
    <el-dialog v-model="dialogVisible" title="编辑合同" width="98%" center top="10px" class="editContract"
...
const submit = (formRef) => {
    ...
    formRef.validate((valid) => {
        if (valid) {
            ...
            loading.value = true;
            contractApi.editContract(form.value).then(res => {
